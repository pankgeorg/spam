...
using the usual physics assumptions.  Would be great if the predictions could be experimentally verified. (Prof. Alan Edelman, MIT, 2021) --> 4
"""
...
md"""
###  Car Park, NY Suffolk County | MESSING REMOTELY! again!!
"""
